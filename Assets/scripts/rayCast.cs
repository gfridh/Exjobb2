...
/*          print(((internalCoordinates.y/256)*(170/Mathf.Pow(2, zoomLevel)/2)*2 + currentMiddlelatitude));
            ...
            if (Input.GetKeyDown("space")){
                ...
                googleScript.lat = ((internalCoordinates.y/256)*(170/Mathf.Pow(2, zoomLevel)/2)*2 + currentMiddlelatitude);
                googleScript.lon = (internalCoordinates.x/256)*(360/Mathf.Pow(2, zoomLevel)/2)*2 + currentMiddlelongitude;
                googleScript.zoom ++;
                zoomLevel ++;
